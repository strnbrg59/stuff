...
; Calling conventions consistent with Microsoft and Turbo C compilers.
...
;----------------------------------------------------------------
;	writchr(C,N)
;	WRITE CHAR N TIMES AT CURSOR POSITION, NO ATTRIBUTE CHANGE
...
;----------------------------------------------------------------
;	writblr(C,N)
;	WRITE CHAR C N TIMES IN BLINKING REVERSE VIDEO MODE
...
;----------------------------------------------------------------
;	INCCSR	INCREMENT CURSOR POSSITION
