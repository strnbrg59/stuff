discwind : cncttime.o forcesal.o options.o bldordr.o cancel.o dispordr.o disptrad.o discwind.o menu.o\
       client.o orders.o password.o holdings.o trades.o util.o diary.o loadsec.o xmem.o
	cc -o discwind cncttime.o forcesal.o options.o bldordr.o cancel.o dispordr.o disptrad.o orders.o discwind.o \
