exdiv : forcesal.o options.o bldordr.o cancel.o dispordr.o disptrad.o exdiv.o menu.o\
       client.o orders.o password.o holdings.o trades.o util.o diary.o loadsec.o xmem.o
	cc -o exdiv forcesal.o options.o bldordr.o cancel.o dispordr.o disptrad.o orders.o exdiv.o \
